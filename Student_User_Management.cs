...
{
    public partial class Student_User_Management : Form
    {
        private string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public Student_User_Management()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: This line of code loads data into the 'system_DatabaseDataSet.Student' table. You can move, or remove it, as needed.
            this.studentTableAdapter.Fill(this.system_DatabaseDataSet.Student);
            ...
            string query = "select FullName, Username, Gender, Email, Education, Password, ProfilePicture from Student";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "select * from Student where Username like '" + textBox1.Text + "%' ";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            DataTable data = new DataTable();
            sda.Fill(data);
            dataGridView1.DataSource = data;
